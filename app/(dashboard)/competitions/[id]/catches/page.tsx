      ...
      <>
        ...
        <div className="min-h-screen px-4 py-6">
          <div className="max-w-lg mx-auto">
            ...
            <div className="h-20 w-20 mx-auto bg-surface-muted rounded-2xl mb-4 animate-pulse" />
            <div className="h-8 w-48 mx-auto bg-surface-muted rounded-lg mb-8 animate-pulse" />
  ...
  if (success) {
    return (
      <>
        <style dangerouslySetInnerHTML={{ __html: entranceAnimation }} />
        <div className="fixed inset-0 -z-10">
          <div className="absolute inset-0 bg-gradient-to-br from-status-active-bg via-primary-light to-primary-light" />
          <div className="absolute inset-0 opacity-[0.025]" style={{ backgroundImage: grainTexture }} />
        </div>
        <div className="min-h-screen px-4 flex items-center justify-center">
          <div
            className="bg-white/90 backdrop-blur-sm rounded-3xl border-2 border-status-active/30 shadow-2xl shadow-status-active/20 p-8 md:p-10 text-center max-w-sm w-full"
            style={{ animation: 'scaleIn 0.4s ease-out forwards' }}
          >
            {/* Success Icon */}
            <div
              className="w-24 h-24 mx-auto rounded-2xl bg-gradient-to-br from-status-active to-status-active flex items-center justify-center mb-6 shadow-lg shadow-status-active/30"
            ...
            <div className="my-6 py-4 px-6 bg-status-active-bg rounded-xl border border-status-active/30">
              <span className="text-4xl font-bold text-status-active">{fishCount}</span>
              <span className="block text-sm text-status-active mt-1 font-medium">
    ...
    <>
      ...
      <div className="min-h-screen px-4 py-6 pb-32 sm:pb-6">
        <div className="max-w-lg mx-auto">
          ...
          >
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-status-active to-primary rounded-2xl mb-4 shadow-xl shadow-status-active/25">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            >
              <div className="p-5 border-b border-surface-border/50">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="font-semibold text-text-primary">Photo</h2>
                    <p className="text-xs text-text-muted">Immortalisez votre prise</p>
                  </div>
                  <span className="ml-auto px-2.5 py-1 rounded-lg text-xs font-medium bg-surface-bg text-text-secondary">
                    Optionnel
                  </span>
                </div>
              </div>
                  ...
                  <div className="relative rounded-xl overflow-hidden group">
                    ...
                    <div className="absolute inset-0 bg-slate-900/60 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex items-center justify-center gap-3">
                      <button
                        ...
                        className="px-4 py-2.5 bg-white/90 text-text-primary rounded-xl font-medium text-sm hover:bg-white transition-colors"
                      >
                        Changer
                      </button>
                      <button
            ...
            >
              <div className="p-5 border-b border-surface-border/50">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-status-active/20 to-status-active/5 flex items-center justify-center">
                    <svg className="w-6 h-6 text-status-active" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M7 20l4-16m2 16l4-16M6 9h14M4 15h14" />
                    </svg>
                  </div>
                  <div>
                    <h2 className="font-semibold text-text-primary">Nombre de prises</h2>
                    <p className="text-xs text-text-muted">Combien de poissons ?</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-5">
                    ...
                    <button
                      ...
                      className={`relative min-h-[56px] rounded-xl font-bold text-xl transition-all duration-150 active:scale-95 ${
                        fishCount === count
                          ...
                          : 'bg-surface-bg text-text-secondary hover:bg-surface-muted'
                      }`}
                    >
                      {count}
                      {fishCount === count && (
                        <div className="absolute -top-1.5 -right-1.5 w-6 h-6 rounded-full bg-status-active-bg0 flex items-center justify-center shadow-md">
                ...
                <div className="flex items-center gap-3 p-4 bg-surface-bg rounded-xl">
                  <span className="text-text-secondary text-sm font-medium">Autre :</span>
                  <input
                    type="number"
                    inputMode="numeric"
                    min="1"
                    ...
                    className="flex-1 px-4 py-3 bg-white border border-surface-border rounded-xl text-center text-xl font-bold text-text-primary focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all"
                  />
                </div>
              </div>
            </div>
            ...
            >
              <button
                ...
                className="w-full p-5 flex items-center justify-between hover:bg-surface-bg/50 transition-colors active:bg-surface-bg/50"
              >
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-accent-amber/20 to-accent-amber/5 flex items-center justify-center">
                  ...
                  <div className="text-left">
                    <h2 className="font-semibold text-text-primary">Détails des poissons</h2>
                    <p className="text-xs text-text-muted">Tailles et leurres (optionnel)</p>
                  </div>
                </div>
                <div className={`w-10 h-10 rounded-xl bg-surface-bg flex items-center justify-center transition-transform duration-200 ${showDetails ? 'rotate-180' : ''}`}>
                  <svg className="w-5 h-5 text-text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {showDetails && (
                <div className="p-5 border-t border-surface-border/50" style={{ animation: 'slideInUp 0.3s ease-out forwards' }}>
                  <p className="text-sm text-text-muted mb-4">
                    Remplissez uniquement les poissons que vous souhaitez détailler
                  </p>
                  <div className="space-y-3">
                    {Array.from({ length: fishCount }).map((_, index) => (
                      <div key={index} className="p-4 bg-surface-bg rounded-xl">
                        <div className="flex items-center gap-2 mb-3">
                          ...
                          <span className="font-medium text-text-secondary">Poisson {index + 1}</span>
                        </div>
                        <div className="grid grid-cols-2 gap-3">
                          <div>
                            <label className="text-xs font-medium text-text-secondary mb-1.5 block">Taille</label>
                            <div className="relative">
                              <input
                                ...
                                className="w-full px-4 py-3 pr-12 bg-white border border-surface-border rounded-xl text-center font-semibold text-text-primary focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all"
                                placeholder="85"
                              />
                              <span className="absolute right-4 top-1/2 -translate-y-1/2 text-text-muted font-medium text-sm">
                                cm
                              </span>
                            </div>
                          </div>
                          <div>
                            <label className="text-xs font-medium text-text-secondary mb-1.5 block">Leurre</label>
                            <input
                              type="text"
                              value={fishLures[index] || ''}
                              onChange={(e) => handleLureChange(index, e.target.value)}
                              className="w-full px-4 py-3 bg-white border border-surface-border rounded-xl text-text-primary focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all"
            ...
            >
              ...
              <button
                type="submit"
                disabled={submitting}
                className="flex-1 flex items-center justify-center gap-2 px-6 py-3.5 bg-gradient-to-r from-status-active to-primary text-white rounded-xl font-semibold shadow-lg shadow-status-active/25 hover:shadow-xl hover:shadow-status-active/30 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:scale-100"
              >
                {submitting ? (
                  <>
                    <svg className="animate-spin w-5 h-5" fill="none" viewBox="0 0 24 24">
      ...
      <div className="sm:hidden fixed bottom-0 left-0 right-0 p-4 bg-white/95 backdrop-blur-md border-t border-surface-border shadow-[0_-4px_20px_rgba(0,0,0,0.08)]">
        <div className="flex gap-3 max-w-lg mx-auto">
          <button
            type="button"
            onClick={() => router.push(`/competitions/${competitionId}`)}
            className="min-h-[52px] px-5 bg-white border border-surface-border text-text-secondary rounded-xl font-medium hover:bg-surface-bg transition-all shadow-sm"
          >
            Annuler
          </button>
          <button
            ...
            disabled={submitting}
            className="flex-1 min-h-[52px] flex items-center justify-center gap-2 px-6 bg-gradient-to-r from-status-active to-primary text-white rounded-xl font-semibold shadow-lg shadow-status-active/25 active:scale-[0.98] transition-all disabled:opacity-70 disabled:cursor-not-allowed"
          >
            {submitting ? (
              <>
                <svg className="animate-spin w-5 h-5" fill="none" viewBox="0 0 24 24">
